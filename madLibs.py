...
def story():
    ...
    print("I picked up my " + n[3] + " to check the time.\u001b[31m Yikes!\u001b[0m I was already " + str(getNumber(num)) + " minutes late!")
    print("I " + adv[0] + " threw on some clothes and ran to the bathroom to " + v[3] + " my " + n[1])
    print("Suddenly, the hangover hit.")
    print("My brain felt\u001b[32m " + adj[0] + "\u001b[0m. I slumped to the floor like a bag of " + n[2] + "(e)s.")
    print("Just then, as if to rescue itself, my brain had a burst of pure " + adj[1] + "! My \u001b[33mJUUL\u001b[0m was on my nightstand!")
    print("It would give me the dopamine rush I needed to power through and " + adv[1] + " " + v[2] + " to school.")
    print("I " + v[1] + "ed over to my nightstand, grabbed it and dipped with the \u001b[33mJUUL\u001b[0m " + v[0] + " between my teeth.")
    print("Finally, I was out the door. I sprinted " + adv[3] + " down the block.")
    print("Just as I turned the corner, the \u001b[33mJUUL\u001b[0m flew out of my mouth and into the street drain.")
